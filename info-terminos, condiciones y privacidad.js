...
let Terminos = `
*_Toda la informaci¨®n que se mencione aqu¨ª no excluye a la Propietario del Bot, y Propietarios Acredores al uso de The LoliBot-MD_*
*_No Somos responsables del desconocimiento que tenga por parte de esta informaci¨®n._* 
*T?RMINOS DE PRIVACIDAD*
_- Somos consciente del constante uso que le pueda dar al Bot, y tambi¨¦n Garantizamos que la informaci¨®n como (im¨¢genes, v¨ªdeos, enlaces, ubicaci¨®n, Audios, Stickers, Gif, Contactos que Usted Proporcione en torno a N¨²mero(s) Oficial(es) No son ni ser¨¢n Compartido Con Nadie, ni se usaran dicho Datos fuera del entorno del BOT._
...
_- Es posible que en N¨²mero(s) Oficial(es) el Bot no est¨¦ Activado las 24 Horas de los 7 d¨ªas de la Semana, eso no implica que no lo est¨¦ o que Propietarios NO OFICIALES puedan Hacerlo._
...
_- El Bot contiene Material que solo puede ser visible para mayores de 18 A?os, NO somos responsable si no cumple con la edad m¨ªnima para usar el Material para Adultos._
_- Las im¨¢genes, V¨ªdeos y Audios que tenga este Bot son de uso P¨²blico, Pero se considerar¨¢ Falta de Respeto al realizar Ediciones en el Material ya exitente que porte Nombre del Bot o informaci¨®n relevante._
