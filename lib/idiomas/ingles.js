...
const smsLista1 = () => { return `🌟 ANDY INFORMATION 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALL ANDYBOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 Super Andybot - WhatsApp '}
...
const eGataCoins = () => { return '🐱 ANDYCOINs' }
...
const smsModP2 = () => { return `Enable function so everyone can use AndYMD`}
