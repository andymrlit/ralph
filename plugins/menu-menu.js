...
let pp = andyVidMenu.getRandom()
let fkontak = { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" }
let fsizedoc = '1'.repeat(10)
let adReply = { fileLength: fsizedoc, seconds: fsizedoc, contextInfo: { forwardingScore: fsizedoc, externalAdReply: { showAdAttribution: true, title: wm, body: '👋 ' + username, mediaUrl: ig, description: 'Hola', previewType: 'PHOTO', thumbnail: await(await fetch(andyMenu.getRandom())).buffer(), sourceUrl: redesMenu.getRandom() }}}
...
*╰*┅┅┅┅┅┅┅┅┅┅┅┅┅ *✧*
${readMore}
*╭━〔 INFORMACIÓN DE andyBOT 〕⬣*
┃💫➺ _${usedPrefix}cuentasandybot | cuentasgb_
┃💫➺ _${usedPrefix}gruposgb | grupos | groupgb_
┃💫➺ _${usedPrefix}donar | donate_
┃💫➺ _${usedPrefix}listagrupos | grouplist_
┃💫➺ _${usedPrefix}estado | heyandy | status_
┃💫➺ _${usedPrefix}infoandy | infobot_
...
*╭━━[ BÚSQUEDAS 🔍 ]━━⬣*
┃ *Busca lo que quieres con andyBot!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
┃⚗️➺ _${usedPrefix}minarandycoins | minarcoins_
...
┃💎➺ _${usedPrefix}darandycoins *cantidad*_
...
┃💎➺ _${usedPrefix}delandycoins *@tag*_
...
┃💎➺ _${usedPrefix}añadirandycoins *@tag cantidad*_
*╰━━━━━━━━━━━━⬣*
`.trim()
