...
🎰 | *RANURAS* | 🎰 
 ...
 ────────
🎰 |   *SLOTS*   | 🎰`
await conn.sendHydrated(m.chat, `${s}\n\n${end}`, wm, null, md, '𝗔𝗡𝗗𝗬-𝗠𝗗', null, null, [
...
if (command == 'slot') {       
await conn.sendHydrated(m.chat, `*Elija en que apostará ${apuesta}*`, wm, null, md, '𝗔𝗡𝗗𝗬-𝗠𝗗', null, null, [
