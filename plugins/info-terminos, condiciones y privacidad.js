...
let Terminos = `
*_Toda la información que se mencione aquí no excluye a la Propietaria del Bot, y Propietarios Acredores al uso de AndyMdBot-MD_*
...
_- El chat anónimo del comando #start, valga la redundancia no mostrará ningún dato de los Usuarios por parte de AndyMdBot. Eso no implica que las personas que hagan uso de esta función puedan dar a conocer sus datos. en Número(s) Oficial(es)._

_- Los Datos que Obtenga AndyMdBot en Cuentas Oficiales de Usuarios(as), Grupos y Ajustes del Mismo puede verse Reiniciado, Modificado, y/o Retificado con el fin de que el Bot este en Óptimas Condiciones para su Uso. (Usuarios(as) Pueden Pedir Compensación Por Instagram o por el comando #Reporte. Debe de Presentar Pruebas)._
...
_- Las Cuentas Oficiales de AndyMdBot no se hacen responsable del Uso que usted haga con la función "Sub Bot"._
...
_- Al hacer uso de ciertos comandos que tengan como objetivo socavar la incomodidad, intranquilidad, molestia u otro termino tajante, se tomarán las respectivas sanciones o llamados de alerta para prevalecer la integridad de los/las Usuarios(as) y funcionamiento de AndyMdBot._
...
~ _Solo en esta Cuenta Respondo si tiene Dudas, Preguntas o Necesita Ayuda sobre AndyMdBot, También puede Comunicarse en Caso de Temas de Colaboración_
...
*https://paypal.me/andyUSA*


*~ Muchas Gracias Por tomarte el tiempo en informate sobre AndyMdBot*
`.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | https://www.instagram.cs`, pp, 'https://github.com/andy_mr_lit', 'AndyMd', null, null, [
